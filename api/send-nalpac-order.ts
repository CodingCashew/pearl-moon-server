...
function formatNalpacOrder(nalpacOrder: Order) {
  ...
  // const shippingOptionId = 125816; // USPS Priority Mail (find a cheaper option)
  //  <ShippingOptionId>${shippingOptionId}</ShippingOptionId>
  // ^ I think I can omit this line from the XML and it will default to the cheapest shipping option available.
